            ...
            <div class="container">
                <div class="row">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="profile.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                                        else{
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="p2.jpg" height=100 width=100 alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sony DSLR</h3>
